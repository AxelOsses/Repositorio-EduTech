...
public class NotaEvaluacionController {
    ...
    @GetMapping("/{id}")
    public Optional<NotaEvaluacion> getNotaEvaluacionById(@PathVariable UUID id) {
    ...
    @PutMapping("/{id}")
    public NotaEvaluacion updateNotaEvaluacion(@PathVariable UUID id, @RequestBody NotaEvaluacion updatedNotaEvaluacion) {
        updatedNotaEvaluacion.setId(id);
        return notaEvaluacionService.saveNotaEvaluacion(updatedNotaEvaluacion);
    }

    @DeleteMapping("/{id}")
    public void deleteNotaEvaluacion(@PathVariable UUID id) {
